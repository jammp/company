<?php /* Smarty version 2.6.26, created on 2014-08-01 11:56:12
...
unset($_smarty_tpl_vars);
 ?>
  <div id="mainBox" style="padding-top:18px;">
   <?php if ($this->_tpl_vars['sys_info']['install_exists']): ?>
   <div class="warning"><?php echo $this->_tpl_vars['lang']['warning_install']; ?>
</div>
   <?php endif; ?>
   <span id="douApi"></span>
...
：</td>
        ...
        <tr>
         <td height="45" colspan="4" align="center" valign="top">
          <table border="0" cellspacing="0" cellpadding="0" class="tableNobor">
           <tr>
...
?>
 ...
 (<?php echo $this->_tpl_vars['sys_info']['ip']; ?>
   ...
   <?php elseif ($this->_tpl_vars['rec'] == 'about'): ?>
   ...
   <div class="indexBox">
    ...
    <ul>
     <table width="100%" border="0" cellspacing="0" cellpadding="6" class="tableBasic">
      <tr>
       <td width="100">
         <?php echo $this->_tpl_vars['lang']['about_site']; ?>
：
       </td>
       <td>
       <a href="http://www.douco.com" target="_blank">http://www.douco.com</a></td>
      </tr>
      <tr>
       <td>
         <?php echo $this->_tpl_vars['lang']['about_bbs']; ?>
：
       </td>
       <td>
       <a href="http://bbs.douco.com" target="_blank">http://bbs.douco.com </a></td>
      </tr>
      <tr>
       <td>
         <?php echo $this->_tpl_vars['lang']['about_download']; ?>
：
       </td>
       <td>
       <a href="http://www.douco.com/download.html" target="_blank">http://www.douco.com/download.html</a></td>
      </tr>
      <tr>
       <td>
         <?php echo $this->_tpl_vars['lang']['about_email']; ?>
：
       </td>
       <td>
         hi@douco.com</td>
...
：
       ...
       <td>
       <a href="http://bbs.douco.com/forum-37-1.html" target="_blank"><?php echo $this->_tpl_vars['lang']['about_bbs_a']; ?>
</a> <a href="http://bbs.douco.com/forum-38-1.html" target="_blank"><?php echo $this->_tpl_vars['lang']['about_bbs_b']; ?>
</a> <a href="http://bbs.douco.com/forum-39-1.html" target="_blank"><?php echo $this->_tpl_vars['lang']['about_bbs_c']; ?>
</a> <a href="http://bbs.douco.com/forum-40-1.html" target="_blank"><?php echo $this->_tpl_vars['lang']['about_bbs_d']; ?>
</a></td>
      </tr>
     </table>
    </ul>
