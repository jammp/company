<?php /* Smarty version 2.6.26, created on 2014-08-01 05:54:21
...
<div id="wrapper">
 ...
 <div class="license">
  <form action="" method="post">
   <ul>
    <textarea name="request" cols="90" rows="15" readonly="readonly">DouPHP企业网站管理系统最终用户授权许可协议

感谢您选择DouPHP企业网站管理系统（以下简称DouPHP），DouPHP提供一个轻量级企业网站解决方案，基于 PHP + MySQL 的技术开发，全部源码开放。
DouPHP 的官方网址是： www.douco.com 交流论坛：bbs.douco.com
...
三、协议规定的约束和限制
1.未获商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目的或实现盈利的网站）。购买商业授权请登陆www.douco.com了解最新说明。
2.未经官方许可，不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。
3.不管您的网站是否整体使用 DouPHP ，还是部份栏目使用 DouPHP，在您使用了 DouPHP 的网站主页上必须保留模板footer.htm中相关版权信息链接。
...
版权所有 ©2013-2014，douco.com 保留所有权利。

协议发布时间：2013年8月25日

版本最新更新：2013年8月25日 By douco.com</textarea>
    <div class="agree">
     <label>
