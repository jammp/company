<?php /* Smarty version 2.6.26, created on 2014-08-01 16:05:10
...
" />
    ...
    <?php elseif ($this->_tpl_vars['rec'] == 'edit'): ?>
...
" size="40" class="inpMain" <?php if ($this->_tpl_vars['user']['action_list'] != 'ALL'): ?>readonly="true"<?php endif; ?>/>
      ...
      <tr>
       ...
       <td>
        <input type="password" name="new_password" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
       ...
       <td>
        <input type="password" name="new_password_confirm" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td></td>
...
" />
    ...
    <?php elseif ($this->_tpl_vars['rec'] == 'manager_log'): ?>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     <tr>
      <th width="30" align="center"><?php echo $this->_tpl_vars['lang']['record_id']; ?>
</th>
      <th width="100" align="left"><?php echo $this->_tpl_vars['lang']['manager_log_create_time']; ?>
</th>
