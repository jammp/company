...
<link href="http://localhost/theme/default/style.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="http://localhost/theme/default/images/jquery.min.js"></script>
<script type="text/javascript" src="http://localhost/theme/default/images/global.js"></script>
</head>
<body>
<div id="wrapper">
...
"><?php echo $this->_tpl_vars['article']['title']; ?>
         ...
         <dd><?php echo ((is_array($_tmp=$this->_tpl_vars['article']['description'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 100, "...") : smarty_modifier_truncate($_tmp, 100, "...")); ?>
</dd>
       </dl>
