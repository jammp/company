...
<div id="top">
 <div class="wrap">
  <ul class="topNav">
   <li><a href="javascript:AddFavorite('<?php echo $this->_tpl_vars['root_url']; ?>
...
" /></a>
  ...
  <ul class="search">
   <form name="search" id="search" method="get" action="<?php echo $this->_tpl_vars['root_url']; ?>
">
...
<div id="mainNav">
 <ul class="wrap">
  <li<?php if ($this->_tpl_vars['index']): ?> class="cur"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['root_url']; ?>
...
?> 
  <li<?php if ($this->_tpl_vars['nav_list']['cur']): ?> class="cur hover"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['nav']['url']; ?>
