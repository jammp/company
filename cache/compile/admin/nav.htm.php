<?php /* Smarty version 2.6.26, created on 2014-08-01 11:58:55
    ...
    <div class="navList">
     ...
     <table width="100%" border="0" cellpadding="10" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <th align="center"><?php echo $this->_tpl_vars['lang']['sort']; ?>
</th>
...
"><?php echo $this->_tpl_vars['lang']['del']; ?>
    ...
    <?php elseif ($this->_tpl_vars['rec'] == 'add'): ?>
    <div class="idTabs">
      <ul class="tab">
        <li><a href="#nav_add"><?php echo $this->_tpl_vars['lang']['nav_site']; ?>
</a></li>
        <li><a href="#nav_external"><?php echo $this->_tpl_vars['lang']['nav_external']; ?>
</a></li>
      </ul>
      <div class="items">
        <div id="nav_add">
...
?>
              <option value="page,<?php echo $this->_tpl_vars['page_list']['id']; ?>
,<?php echo $this->_tpl_vars['page_list']['page_name']; ?>
"><?php echo $this->_tpl_vars['page_list']['mark']; ?>
 <?php echo $this->_tpl_vars['page_list']['page_name']; ?>
</option>
              <?php $_from = $this->_tpl_vars['page_list']['child']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['child']):
?>
              <option value="page,<?php echo $this->_tpl_vars['child']['id']; ?>
,<?php echo $this->_tpl_vars['child']['page_name']; ?>
"> - <?php echo $this->_tpl_vars['child']['page_name']; ?>
</option>
              <?php endforeach; endif; unset($_from); ?>
              <?php endforeach; endif; unset($_from); ?>
              <option value="article_category,0,<?php echo $this->_tpl_vars['lang']['nav_article']; ?>
">---<?php echo $this->_tpl_vars['lang']['nav_article']; ?>
---</option>
...
?>
              <option value="article_category,<?php echo $this->_tpl_vars['cate']['cat_id']; ?>
,<?php echo $this->_tpl_vars['cate']['cat_name']; ?>
"><?php echo $this->_tpl_vars['cate']['mark']; ?>
 <?php echo $this->_tpl_vars['cate']['cat_name']; ?>
</option>
              <?php endforeach; endif; unset($_from); ?>
              <option value="product_category,0,<?php echo $this->_tpl_vars['lang']['nav_product']; ?>
">---<?php echo $this->_tpl_vars['lang']['nav_product']; ?>
---</option>
              <?php $_from = $this->_tpl_vars['product_category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['cate']):
?>
              <option value="product_category,<?php echo $this->_tpl_vars['cate']['cat_id']; ?>
,<?php echo $this->_tpl_vars['cate']['cat_name']; ?>
"><?php echo $this->_tpl_vars['cate']['mark']; ?>
 <?php echo $this->_tpl_vars['cate']['cat_name']; ?>
</option>
              <?php endforeach; endif; unset($_from); ?>
              <option value="0">---<?php echo $this->_tpl_vars['lang']['nav_other']; ?>
---</option>
              <option value="guestbook,-1,<?php echo $this->_tpl_vars['lang']['guestbook']; ?>
"><?php echo $this->_tpl_vars['lang']['guestbook']; ?>
</option>
             </select>
            </td>
           </tr>
           <tr>
            ...
            <td>
             <label for="type_0">
 <input type="radio" name="type" id="type_0" value="middle" checked="true" onChange="dou_callback('nav.php?rec=nav_list&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')">
 <?php echo $this->_tpl_vars['lang']['nav_type_middle']; ?>
</label>
<label for="type_1">
 <input type="radio" name="type" id="type_1" value="top" onChange="dou_callback('nav.php?rec=nav_list&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')">
 <?php echo $this->_tpl_vars['lang']['nav_type_top']; ?>
</label>
<label for="type_2">
 <input type="radio" name="type" id="type_2" value="bottom" onChange="dou_callback('nav.php?rec=nav_list&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')">
    ...
    <form action="nav.php?rec=update" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      ...
      <tr>
       ...
       <td>
        <input type="text" name="nav_name" value="<?php echo $this->_tpl_vars['nav_info']['nav_name']; ?>
" size="40" class="inpMain" />
      ...
      <td>
       <label for="type_0">
       <input type="radio" name="type" id="type_0" value="middle"<?php if ($this->_tpl_vars['nav_info']['type'] == 'middle'): ?> checked="true"<?php endif; ?> onChange="dou_callback('nav.php?rec=nav_list&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')"><?php echo $this->_tpl_vars['lang']['nav_type_middle']; ?>
</label>
       <label for="type_1">
       <input type="radio" name="type" id="type_1" value="top"<?php if ($this->_tpl_vars['nav_info']['type'] == 'top'): ?> checked="true"<?php endif; ?> onChange="dou_callback('nav.php?rec=nav_list&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')"><?php echo $this->_tpl_vars['lang']['nav_type_top']; ?>
</label>
       <label for="type_2">
       <input type="radio" name="type" id="type_2" value="bottom"<?php if ($this->_tpl_vars['nav_info']['type'] == 'bottom'): ?> checked="true"<?php endif; ?> onChange="dou_callback('nav.php?rec=nav_list&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')"><?php echo $this->_tpl_vars['lang']['nav_type_bottom']; ?>
     ...
     <tr>
       ...
       <td>
        ...
        <input type="text" name="guide" value="<?php echo $this->_tpl_vars['nav_info']['guide']; ?>
" size="60" class="inpMain" />
        <?php else: ?>
        <input type="text" name="guide_no" value="<?php echo $this->_tpl_vars['nav_info']['guide']; ?>
