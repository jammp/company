<?php /* Smarty version 2.6.26, created on 2014-08-01 11:59:53
...
?>
        ...
        <form action="show.php?rec=update" method="post" enctype="multipart/form-data">
         <tr>
         ...
         <tr>
          <td colspan="4">
           <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableNobor">
            <tr>
             <td><?php echo $this->_tpl_vars['lang']['show_name']; ?>
:
...
">
         <tr>
          <td height="40" colspan="4">
           <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableNobor">
            <tr>
             <td><a href="show.php" class="btnGray"><?php echo $this->_tpl_vars['lang']['cancel']; ?>
</a></td>
             <td align="right">
