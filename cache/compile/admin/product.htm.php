<?php /* Smarty version 2.6.26, created on 2014-08-01 12:00:03
...
" />
    ...
    <a class="btnGray" href="product.php?rec=home_sort_close"><?php echo $this->_tpl_vars['lang']['home_sort_close']; ?>
</a>
    <?php else: ?>
...
">X</a>
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        ...
        <th width="60" align="center"><?php echo $this->_tpl_vars['lang']['product_category']; ?>
</th>
...
<?php else: ?>0<?php endif; ?>" size="40" class="inpMain" />
      ...
      <tr>
       <td align="right"><?php echo $this->_tpl_vars['lang']['product_defined']; ?>
</td>
       <td>
        <textarea name="defined" id="defined" cols="20" class="textAreaAuto" style="height:<?php echo $this->_tpl_vars['product']['defined_count']; ?>
0px"><?php echo $this->_tpl_vars['product']['defined']; ?>
      ...
      <tr>
       ...
       <td>
        ...
        <!-- /KindEditor -->
        <textarea id="content" name="content" style="width:680px;height:300px;" class="textArea"><?php echo $this->_tpl_vars['product']['content']; ?>
</textarea>
       </td>
      </tr>
      <tr>
       <td align="right"><?php echo $this->_tpl_vars['lang']['product_image']; ?>
</td>
       <td>
